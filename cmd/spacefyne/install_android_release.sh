...
(cd $GOPATH/src/aletheiaware.com/spacefynego/cmd/spacefyne && fyne release -os android -appID com.aletheiaware.space -appBuild 1 -appVersion 1.1.7 -keyStore=$GOPATH/src/aletheiaware.com/spacefynego/private/SPACE.keystore -name SPACE)
